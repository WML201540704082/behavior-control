      ...
      <div class="xt-layout page_body">
        <div class="xt-layout-content" style="height: 84vh; padding: 0px 0px 0px 20px">
          ...
          <el-table ref="table"
            ...
            <af-table-column label="部门名称" prop="deptName" min-width="300" show-overflow-tooltip align="left"></af-table-column>
            <af-table-column label="部门全称" prop="fullName" min-width="300" show-overflow-tooltip align="center"></af-table-column>
            ...
            <af-table-column label="操作" width="300" align="center" fixed="right">
              <template slot-scope="scope">
                <div class="vh_center">
                  <div>
                    <div class="d_start">
