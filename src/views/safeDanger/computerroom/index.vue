            ...
            <el-row>
              <el-col :span="6">
                <el-form-item label="督察分类:" prop="category">
                  <el-select v-model="queryParams.category" placeholder="" clearable>
                    <el-option
          ...
          <el-table
            ...
            >
              <template slot-scope="scope">
                <el-button type="primary" size="mini" v-if='scope.row.parentId == 0 && !scope.row.supervision' @click="handleRow(scope.row)">绑定整改责任人</el-button>
              </template>
            </el-table-column>
          </el-table>
          <pagination
...
import { securityList, securityDelete, allCategory } from "@/api/safeDanger/computerroom"
