<template>
  <div>
    ...
    <div class="hiddenDetail" v-if="hiddenDialogVisible">
      <el-dialog :modal-append-to-body="true" :append-to-body="true" :title="hiddenDialogTitle" style="padding: 0px;"
...
export default {
  ...
  mounted() {
    this.getDictList('hidden_category_standard')
  },
  methods: {
    getDictList(code) {
      //加载字典
      getDictList(code).then(res => {
        if (code === 'hidden_category_standard') {
