  ...
  <basic-container>
        ...
        <el-row>
          <el-col :span="6">
            <el-form-item label="类名" prop="className">
              <el-input placeholder="请输入类名" clearable v-model="searchForm.className">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
    ...
    <div class="page_body">
      ...
      >
        ...
        <!-- <el-table-column prop="success" label="是否成功" width="100" align="center" :formatter="changeStatus" show-overflow-tooltip></el-table-column> -->
        <el-table-column prop="" label="接口使用次数" width="130" align="center" show-overflow-tooltip>
          <template slot-scope="scope">
            <span>0</span>
          </template>
        </el-table-column>
        <el-table-column prop="" label="接口有效性" width="130" align="center" show-overflow-tooltip>
          <template slot-scope="scope">
            <span>有效</span>
          </template>
        </el-table-column>
        <el-table-column prop="className" label="类名" width="300" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="ip" label="ip地址" width="150" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="regionName" label="用户区域" width="150" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="text" label="参数值" width="300" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="tripleType" label="三方系统" width="200" align="center" show-overflow-tooltip></el-table-column>
...
<script>
  import {getTripleapilogList} from "@/api/dataSharing/dataLog";
  import {getDictList} from "@/api/dict";
  import threelogDetail from './components/dataLog/threelogDetail'
