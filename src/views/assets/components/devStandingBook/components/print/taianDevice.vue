          ...
          <div class="d_t_left d_start">
            <div>
              <span class="s_label" style="display: flex;justify-content: space-between">
                <span>部</span>
                <span style="padding-left: 28px">门</span>
              </span>
            </div>
            <div style="white-space: nowrap">
              <span>: {{ formValue.receiveDept }}</span>
            </div>
          </div>
          <div class="d_t_left d_start">
            <span class="s_label" style="display: flex;justify-content: space-around;">
              <span>责</span>
              <span style="display: block;padding: 0px 7px">任</span>
              <span>人</span>
            </span>
            <span>: {{ formValue.receivingPerson }}</span>
          </div>
          <div class="d_t_left d_start">
            <span class="s_label">资产类型</span>
            <span>: {{ formValue.deviceType }}</span>
          </div>
          <div class="d_t_left d_start">
            <span class="s_label">资产名称</span>
            <span>: {{ formValue.fullName }}</span>
          </div>
          <div class="d_t_left d_start">
            <span class="s_label" style="display: flex;justify-content: space-around;">
              <span>序</span>
              <span style="display: block;padding: 0px 7px">列</span>
              <span>号</span>
            </span>
            <span>: {{ formValue.sn }}</span>
          </div>
          <div class="d_t_left d_start">
            <span class="s_label">资产编码</span>
            <span>: {{ formValue.assetCodeErp }}</span>
          </div>
        </div>
      </div>
