  ...
  <basic-container>
        ...
        <el-row :gutter="10">
          ...
          <el-col :span="6">
            <el-form-item label="终端IP" prop="ip">
              <el-input v-model="searchForm.url"  placeholder="请输入终端IP" clearable style="width:100%"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
    ...
    <div class="page_body">
      ...
      >
        ...
        <el-table-column prop="URL地址" label="url" min-width="150" align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="userName" label="业务系统名称" min-width="100" align="center" show-overflow-tooltip></el-table-column>
