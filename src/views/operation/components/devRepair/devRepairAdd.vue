          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="报修单号" prop="filingNo">
                <el-input placeholder="提交时自动生成" v-model="submitForm.filingNo" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
            ...
            <el-col :span="6">
              <el-form-item label="申请部门" prop="applyDeptName">
                <!-- <el-input v-model="submitForm.applyDeptName"></el-input> -->
                <xt-tree-lzay-select :formValue="submitForm.applyDeptName"
                                   :unit-id="submitForm.applyUnit"
                                   :selectType="'DEPT'"
...
export default {
  components: { devList, xtTreeLzaySelect },
  data() {
    return{
      isDis:true,
      pageLoading: false,
  ...
  methods: {
    getuseApplyDept(val) {
      this.submitForm.applyDept = val.id
      this.submitForm.applyDeptName = val.fullName
      this.$forceUpdate()
    },
