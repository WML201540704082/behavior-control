    ...
    <div class="xt-layout page_body">
      <div class="xt-layout-content" style="height: 84vh; padding: 0px 0px 0px 20px">
          ...
          <el-row :gutter="12">
            ...
            <el-col :span="12">
              <el-form-item label="问题描述" size="small">
                <el-input v-model="queryParams.backDetail" placeholder="请输入问题描述" clearable></el-input>
              </el-form-item>
            </el-col>
        ...
        <el-table ref="table" :data="tableData" stripe border size="small" height="62vh" v-loading="loading">
          ...
          <el-table-column label="反馈编号" prop="backNum" show-overflow-tooltip align="center" width="150"></el-table-column>
          <el-table-column label="问题描述" prop="backDetail" show-overflow-tooltip align="center"></el-table-column>
          <el-table-column label="是否采纳" prop="isAccept" show-overflow-tooltip align="center" width="120">
            <template slot-scope="{ row }">
              <span>{{ conversionDict(row.isAccept, isAcceptOptions) }}</span>
            </template>
          </el-table-column>
          <el-table-column label="所属单位" prop="deptName" show-overflow-tooltip align="center" width="290"></el-table-column>
          <el-table-column label="反馈人员" prop="userName" show-overflow-tooltip align="center" width="120"></el-table-column>
          <el-table-column label="反馈进度" prop="backStatus" show-overflow-tooltip align="center" width="120">
            <template slot-scope="{ row }">
              <span>{{ conversionDict(row.backStatus, backStatusOptions) }}</span>
            </template>
          </el-table-column>
          <el-table-column label="创建时间" prop="createTime" show-overflow-tooltip align="center" width="180"></el-table-column>
...
<script>
import {getList, getDept, feedbackRemove} from "@/api/userFeedback/index.js";
import { getDictList } from '@/api/dict'
import addedit from "./userFeedback/addedit.vue";
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.download(
        "/api/idevelop-system/feedback/export",
        this.queryParams,
        "用户反馈管理.xlsx"
      );
    },
