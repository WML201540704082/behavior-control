  ...
  >
    ...
    >
      <el-row v-if="repairType === '1'">
        <el-col :span="8">
          <el-form-item label="使用人" prop="xx">
            <el-input v-model="searchForm.xx" clearable placeholder="请输入使用人"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
        ...
        <el-col :span="8">
          <el-form-item label="设备来源" prop="deviceSource">
            <el-select v-model="searchForm.deviceSource"  placeholder="请选择设备来源" clearable  >
              <el-option  v-for="dict in deviceSourceList" :key="dict.dictKey"  :label="dict.dictValue" :value="dict.dictValue"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
      </el-row>
          ...
          <el-col :span="8">
            <el-form-item label="设备分类" prop="deviceCategory">
              <el-select v-model="searchForm.deviceCategory"  placeholder="请选择设备分类" clearable @change="deviceCategoryChange">
                <el-option  v-for="dict in deviceCategoryList" :key="dict.dictValue"  :label="dict.dictValue" :value="dict.dictValue"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="设备类型" prop="status" >
              <el-select v-model="searchForm.deviceType"  placeholder="请输入设备类型" clearable >
                <el-option  v-for="dict in deviceTypeList" :key="dict.dictValue"  :label="dict.dictValue" :value="dict.dictValue"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
        <el-col :span="8">
...
<script>
import { getCmdbList, getDictCmdbList, getDictList } from "@/api/dict";
...
export default {
  ...
  methods: {
    ...
    getCmdbDictList(code){
      //加载cmdb字典
      let dict = ['1097745625841664','1097745969774592']
      for(let i=0; i<dict.length; i++) {
