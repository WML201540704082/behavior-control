<template>
  <!-- <basic-container>
    ...
    <div class="page_body" style="padding-right:5px" v-loading="pageLoading"> -->
      <el-scrollbar style="height: 50vh;width:100%">
...
export default {
  ...
  methods: {
    getDetail() {
      ...
      repairOrderDetail({id: this.idd}).then(res => {
      ...
      repairOrderDetailDevlist({repairId: this.idd}).then(res => {
    ...
    loadLogOptDataList() {
      //加载操作记录
      getLogOptList(1, 99, {logId: this.idd}).then(res => {
