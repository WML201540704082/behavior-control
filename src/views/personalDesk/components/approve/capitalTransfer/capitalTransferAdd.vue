      ...
      <el-scrollbar style="height:calc(100% - 80px - 48px)">
        <el-form :model="form" ref="dataForm" class="xt_form" label-width="150px">
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item label="产权单位" prop="ownerUnitName" :rules="[{ required: false, message: '产权单位不能为空'}]"
                            size="small">
            ...
            <el-col :span="8">
              <el-form-item label="产权部门" prop="propertyDeptName"
                            :rules="[{ required: false, message: '产权部门不能为空'}]"
                            size="small">
            ...
            <el-col :span="8">
              <el-form-item label="功能位置" prop="funLocation"
                            :rules="[{ required: false, message: '功能位置不能为空'}]"
                            size="small">
            ...
            <el-col :span="8">
              <el-form-item label="工厂区域" prop="factoryArea"
                            :rules="[{ required: false, message: '工厂区域不能为空'}]"
                            size="small">
  ...
  export default {
    ...
    methods: {
      ...
      handleFactoryArea(val) {
        // console.log(val)
        // console.log(this.factoryAreaList)
      ...
      getErptranstplnrList() {
        //ERP功能位置
        getErptranstplnrList({swerk: this.userDetail.erpUnitCode, current: 1, size: 100}).then(res => {
          this.funLocationList = res.data.records
        })
      },
      getErpmaintainList() {
        //ERP维护工厂
        getErpmaintainList({code: this.userDetail.erpUnitCode, current: 1, size: 100}).then(res => {
