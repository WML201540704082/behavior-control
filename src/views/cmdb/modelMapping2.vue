  ...
  <basic-container>
    ...
    <div class="page_body">
      ...
      >
        ...
        <el-table-column label="C-模型" prop="cmdbCiName" align="left" width="90" show-overflow-tooltip></el-table-column>
        <el-table-column label="C-属性名称" prop="cmdbAttrLabel" align="left" width="140" show-overflow-tooltip></el-table-column>
        <el-table-column label="C-属性编码" prop="cmdbAttrCode" align="left" width="130" show-overflow-tooltip></el-table-column>
        <el-table-column label="C-属性类型" prop="cmdbAttrType" align="left" width="100" show-overflow-tooltip></el-table-column>
        <el-table-column label="I-属性名称" prop="i6000Expan" align="left" show-overflow-tooltip></el-table-column>
        <el-table-column label="I-属性编码" prop="i6000AttrCode" align="left" show-overflow-tooltip></el-table-column>
        <el-table-column label="I-属性数据类型" prop="i6000Datatype" align="left" show-overflow-tooltip></el-table-column>
        <el-table-column label="I-属性值源类型" prop="i6000OriType" align="left" :formatter="changeStatus"
                         show-overflow-tooltip></el-table-column>
        <el-table-column label="I-属性值源数据" prop="i6000Origin" align="left" show-overflow-tooltip></el-table-column>
