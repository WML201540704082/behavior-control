        ...
        <el-table-column label="操作" prop="createTime" align="center" width="220" fixed="right" show-overflow-tooltip>
          <template slot-scope="scope">
            <div>
              ...
              <el-link type="primary" size="mini" :underline="false" style="margin-left: 10px" @click="openUserView(scope.row)" icon="el-icon-user">
                <span class="s_lt">临时账号</span>
              </el-link>
            </div>
          </template>
        </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      openUserView(){
        this.$router.push({
          path: '/xcnanr/ideal/baseAc/ac/account',
          query: {
