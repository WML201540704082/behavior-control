<template>
  <basic-container style="padding-bottom: 60px">
    <breadcrumb path="/xcnanr/ideal/inspectionOrder/index" master-title="巡视任务" child-title="详情"></breadcrumb>
...
export default {
  ...
  methods: {
    ...
    returnEvent() {
      this.$router.push({path: '/xcnanr/ideal/inspectionOrder/index'})
    },
    showImg(row) {
