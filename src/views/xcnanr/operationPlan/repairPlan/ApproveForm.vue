<template>
  <div>
          ...
          <el-col :span="24">
            <div class="grid-content bg-purple" v-loading="approveLoading" style="height: 97px">
              <el-steps :active="2" align-center>
                <el-step title="填报" icon="el-icon-document-add">
                  <template slot="description">
                    <div>{{ childDialogForm.createUserName }}</div>
                    <div>{{ childDialogForm.startTime }}</div>
                  </template>
                </el-step>
                <el-step title="签发" icon="el-icon-s-check">
                  <template slot="description">
                    <div>
                      <span>审批人：</span>
                ...
                <el-step title="终结" icon="el-icon-finished"></el-step>
              </el-steps>
            </div>
          </el-col>
        </el-row>
    ...
    <!-- 新增表单 -->
    <div class="xt_card_xc xt_form xc_base">
      <el-form ref="childDialogForm" :model="childDialogForm" inline size="small" label-suffix=":" label-width="160px" key="11" v-loading="pageLoading">
        <el-row>
          <el-col :span="24">
          ...
          <el-col :span="12" v-if="childDialogForm.type === '2'">
            ...
            <el-form-item label="检修对象类型" prop="type">
              <el-select disabled v-model="childDialogForm.objectType" filterable style="width: 390px">
          ...
          <el-col :span="12" v-if="childDialogForm.type === '1'">
            <el-form-item label="检修操作人" prop="operatorArray">
              <el-select disabled v-model="operatorArray" multiple filterable style="width: 344px">
                <el-option v-for="item in personList" :key="item.id" :label="item.name" :value="item.id"/>
              </el-select>
              <div>
                <el-button class="self-select-button-ad" title="新增被授权人员" icon="el-icon-user" @click="addWorker"></el-button>
              </div>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="24" class="self-input-textarea">
            <div class="grid-contents bg-purple">
              <el-form-item :label="childDialogForm.type === '1' ? '检修内容':'计划内容'" prop="content">
                <el-input disabled v-model="childDialogForm.content" type="textarea" :rows="4" style="width: 1040px;"/>
              </el-form-item>
            </div>
          </el-col>
          <el-col :span="12" v-if="childDialogForm.type === '2'">
            <el-form-item label="检修任务类型" prop="renwuType">
              <el-select disabled v-model="childDialogForm.renwuType" filterable  style="width: 390px">
          ...
          <el-col :span="12" v-if="childDialogForm.type === '2'">
            <el-form-item label="检修级别类型" prop="jiebieType">
              <el-select disabled v-model="childDialogForm.jiebieType" filterable style="width: 390px">
          ...
          <el-col :span="12" v-if="childDialogForm.type === '2'">
            <el-form-item label="是否停运" prop="isTingyun">
              <el-select disabled v-model="childDialogForm.isTingyun" filterable style="width: 390px">
          ...
          <el-col :span="12" v-if="childDialogForm.type === '2'">
            <el-form-item label="是否重要检修" prop="isImport">
              <el-select disabled v-model="childDialogForm.isImport" filterable style="width: 390px">
          ...
          <el-col :span="12" v-if="childDialogForm.type === '2'">
            <el-form-item label="检修单位" prop="jianxiuCompa">
              <el-input disabled v-model="childDialogForm.jianxiuCompa" style="width: 390px"/>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="childDialogForm.type === '2'">
            <el-form-item label="业务主管部门" prop="zhuguanDep">
              <el-select disabled v-model="childDialogForm.zhuguanDep" filterable style="width: 390px">
          ...
          <el-col :span="12" v-if="childDialogForm.type === '2'">
            <el-form-item label="检修主管" prop="jianxiuZg">
              <el-input disabled v-model="childDialogForm.jianxiuZg" style="width: 390px"/>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="childDialogForm.type === '2'">
            <el-form-item label="建设运维单位" prop="yunweiCompa">
              <el-input disabled v-model="childDialogForm.yunweiCompa" style="width: 390px"/>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="childDialogForm.type === '2'">
            <el-form-item label="计划负责人" prop="jihuaHeader">
              <el-input disabled v-model="childDialogForm.jihuaHeader" style="width: 390px"/>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="childDialogForm.type === '2'">
            <el-form-item label="联系电话" prop="lianxiTel">
              <el-input disabled v-model="childDialogForm.lianxiTel" style="width: 390px;"/>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="childDialogForm.type === '2'">
            <el-form-item label="作业组织（建管）单位" prop="jianguanCompa">
              <el-input disabled v-model="childDialogForm.jianguanCompa" style="width: 390px"/>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="childDialogForm.type === '2'">
            <el-form-item label="作业实施（施工）单位" prop="shigongCompa">
              <el-input disabled v-model="childDialogForm.shigongCompa" style="width: 390px"/>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="childDialogForm.type === '2'">
            <el-form-item label="作业风险等级" prop="riskLevel">
              <el-select disabled v-model="childDialogForm.riskLevel" filterable style="width: 390px">
          ...
          <el-col :span="12" v-if="childDialogForm.type === '2'">
            <el-form-item label="涉及设备/软件" prop="software">
              <el-button disabled style="margin-left: 5px" type="primary" @click="chooseDevices">选择设备</el-button>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="childDialogForm.type === '2'">
            <el-form-item label="相关缺陷消缺申请" prop="quexian">
              <el-input disabled v-model="childDialogForm.quexian" style="width: 390px;"/>
            </el-form-item>
          </el-col>
          <el-col :span="24" class="self-input-textarea" v-if="childDialogForm.type === '1'">
            <div class="grid-contents bg-purple">
              <el-form-item label="影响范围" prop="influenceScope">
                <el-input disabled v-model="childDialogForm.influenceScope" type="textarea" :rows="4" style="width: 1040px"/>
              </el-form-item>
            </div>
          </el-col>
<!--          <el-col :span="12" v-if="childDialogForm.type === '1'">-->
<!--            <el-form-item label="风险管控卡" prop="riskId">-->
<!--              <el-select disabled v-model="childDialogForm.riskId" multiple filterable style="width: 390px" @change="syncRiskInfo">-->
...
<!--          </el-col>-->
    ...
    <!-- 检修对象 -->
    <div class="xt_card_xc xt_form xc_base">
      <el-form ref="childDialogFormTwo" :model="childDialogForm" inline size="small" label-suffix=":" label-width="160px" key="22" v-loading="pageLoading">
        <div v-if="childDialogForm.type === '1'">
          <div v-if="childDialogForm.type === '1' && childDialogForm.mode==='2'">
          ...
          <el-form-item style="margin-top: 30px" label="检修对象" prop="deviceIds">
            <el-table ref="deviceTableInfo" :data="deviceTableInfo" style="width: 1040px" max-height="200px" v-loading="tableLoading" @selection-change="selectionChange">
              ...
              <el-table-column v-if="childDialogForm.mode === '1'" label="远程端口" prop="devicePort" width="160" align="center" show-overflow-tooltip />
              <el-table-column v-if="childDialogForm.mode === '1'" label="资产类型" prop="deviceProtocol" width="175" align="center" show-overflow-tooltip>
                <template slot-scope="scope">
              ...
              <el-table-column label="描述" prop="description" :width="childDialogForm.mode === '1' ? 300 : 550" align="center">
                <template slot-scope="scope">
    ...
    <div class="xt_card_xc xt_form xc_base">
      <div class="text item">
        <el-form ref="approveForm" :rules="approveFormRules" :model="approveForm" inline size="small" label-suffix=":"
                 label-width="110px" v-loading="pageLoading" style="margin-left: 40px;">
          <el-row>
            <el-col :span="12">
              <div class="grid-content">
                <el-form-item label="审批人" prop="extAttr1">
                  <el-input v-model="approveForm.extAttr1" disabled style="width: 390px" />
                </el-form-item>
              </div>
            </el-col>
            <el-col :span="12">
              <div class="grid-content bg-purple">
                <el-form-item label="审批结果" prop="result">
                  <el-radio v-model="approveForm.result" :label="'已审批'">同意</el-radio>
                  <el-radio v-model="approveForm.result" :label="'驳回'">不同意</el-radio>
                </el-form-item>
              </div>
            </el-col>
            <el-col :span="24">
              <div class="grid-content bg-purple">
                <el-form-item label="审批意见" prop="content">
                  <el-input v-model="approveForm.content" type="textarea" :rows="3" :maxlength="300" show-word-limit style="width: 1040px"/>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      <!-- 底边按钮 -->
      <el-row style="margin: 30px 0 0 0; display: flex; justify-content: center; align-items: center;" class="self-row-bg" justify="center">
        <el-col :span="2">
          <el-button type="primary" size="small" :loading="saveLoading" @click="approveEvent()">提 交</el-button>
        </el-col>
        <el-col :span="2">
          <el-button stype="primary" plain size="small" tyle="margin-left: 15px;" @click="cancelEvent">取 消</el-button>
        </el-col>
      </el-row>
    </div>
  </div>
...
import { getDetails, approveRepair } from '../../../../api/xcnanr/repairPlan'
...
export default {
  ...
  data() {
    return {
      planCode: '',
      childDialogForm: { companyId: '', companyName: '', deptName: '', deptId: '', type: '1', jobCategory: '', jobType: '', objectType: '', mode: '1', headerId: '', header: '', operatorId: '',
        operator: '', pattern: '2', isTongyi: '1', startTime: '2024-12-21 10:23:45', endTime: '', content: '', renwuType: '', jiebieType: '', isTingyun: '', isImport: '', jianxiuCompa: '',
        zhuguanDep: '', jianxiuZg: '', yunweiCompa: '', jihuaHeader: '', lianxiTel: '', jianguanCompa: '', shigongCompa: '', riskLevel: '', province: '', city: '', district: '', totalUserCount: '',
        itSystem: '', software: '', quexian: '', influenceScope: '', riskId: '', riskContent: '', keySolution: '', companyRegionCode: '', planDetailList: [], createUserName: '', isSumbit: '', deviceRecordDto: { processDefinitionKey: '', approvalOpinion: '' }
      },
      jobCategoryOptions: [],
      jobTypeAllOptions: {},
      pageLoading: false,
  ...
  watch: {
    ...
    'approveForm.result':{
      handler(val) {
        if (val === '已审批') {
          this.approveForm.content = '同意'
        } else {
          this.approveForm.content = '不同意'
        }
      }
    }
  },
  ...
  methods: {
    isApprove() {
      if (this.$route.query.code !== null) {
        // 初始化审批字段（后期可改为回填时获取）
        this.approveForm.extAttr1 = this.userDetail.userName
        this.approveForm.type = this.$route.query.type
        this.approveForm.no = this.$route.query.code
        // 数据回显
        getDetails(this.$route.query.code).then(res => {
          if (res && res.data !== null) {
            let rowData = res.data
            this.planCode = rowData.code
            this.childDialogForm.createUserName =rowData.createUserName
            ...
            if (rowData.type.toString() === '1') {
              ...
              this.childDialogForm.itSystem = rowData.itSystem
              this.childDialogForm.quexian = rowData.quexian
            }
          }
        }).catch((err) => {
          console.log(err, '检修计划详情页的回显报错++++++++++++++')
        })
      }
    },
    /**
     ...
     */
    approveEvent() {
      this.approveForm.deviceRecordDto = {
        id: this.$route.query.id,
        filingNo: this.$route.query.code,
        processDefinitionKey: 'bpm_jxjh',
        approvalOpinion: '审批检修计划',
        type: 'JXJH'
      }
      approveRepair(this.approveForm).then(res => {
        if (res.code === 200) {
          this.$message({
            type: "success",
            message: "提交成功!"
