<template>
  <basic-container style="padding-bottom: 60px">
    <breadcrumb path="/xcnanr/operationPlan/inspectionPlan/index" master-title="巡视计划" child-title="审批"></breadcrumb>
    <div class="text item">
      <el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      returnEvent(){
        document.querySelectorAll('*[id^="tab-/xcnanr/inspectPlanApproval"]')[0].childNodes[1].click()
