<template>
  <basic-container>
    ...
    <div class="page_form" style="padding-bottom: 15px">
      ...
      <div class="table_btn">
        <el-button v-if="permissionList.addBtn" type="primary" style="margin-left: 5px;" @click="handleAdd">新增</el-button>
        <el-button v-if="permissionList.startBtn" type="primary" style="margin-left: 5px;" @click="handleStart(selectionList)">启动</el-button>
        <el-button v-if="permissionList.pauseBtn" type="primary" style="margin-left: 5px;" @click="handleSuspend(selectionList)">暂停</el-button>
