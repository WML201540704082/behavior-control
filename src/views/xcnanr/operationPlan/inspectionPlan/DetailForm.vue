<template>
  <basic-container style="padding-bottom: 60px">
    <breadcrumb path="/xcnanr/operationPlan/inspectionPlan/index" master-title="巡视计划" child-title="详情"></breadcrumb>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      returnEvent(){
        document.getElementById('tab-/xcnanr/inspectPlanDetail/?id='+ this.$route.query.id+'&type=detail').childNodes[1].click()
