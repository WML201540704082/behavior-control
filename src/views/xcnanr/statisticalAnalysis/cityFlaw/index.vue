<template>
  <basic-container>
    ...
    <!-- 页面表格 -->
    <div class="page_body">
      <el-table ref="tableData" :data="tableData" row-key="companyid" :tree-props="{ children: 'child' }" :height="tableHeight" stripe size="small" v-loading="tableLoading">
        <el-table-column label="公司" prop="dept_name" align="center" show-overflow-tooltip/>
        <el-table-column label="缺陷统计（已解决）" prop="yijiejueCount" align="center" show-overflow-tooltip />
        <el-table-column label="缺陷统计（未解决）" prop="weijiejueCount" align="center" show-overflow-tooltip />
        <el-table-column label="合计" prop="hejiCount" align="center" show-overflow-tooltip />
      </el-table>
      <!-- 分页 -->
...
<script>
import { querySolveCount } from '@/api/xcnanr/statisticalAnalysis'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      querySolveCount(this.searchForm).then(res => {
